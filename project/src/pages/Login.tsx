...
function Login() {
  ...
  const { message, returnTo } = (location.state as LocationState) || {};
  ...
  return (
    <div className="min-h-screen bg-[#0F1923] flex items-center justify-center px-4">
      <div className="bg-[#1F2326] p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        {message && (
          <div className="bg-blue-500/10 border border-blue-500 text-blue-500 px-4 py-3 rounded-lg flex items-center gap-2 mb-6">
            <AlertCircle size={20} />
            {message}
          </div>
        )}
        ...
        <p className="text-gray-400 text-center mt-6">
          Não tem uma conta?{' '}
          <Link to="/register" className="text-[#ff4655] hover:text-[#ff4655]/80">
            Cadastre-se
          </Link>
        </p>
      </div>
